---
title: "Contrast Method for Literature-Based Discovery: Short Reproducibility Study"
author: "Erwan Moreau"
date: "May 2021"
...
Two options are possible: the present "short reproducibility study" proposes to use the exact same preprocessed dataset as described in the paper, whereas the "full replication" offers more flexibility but requires much more computing resources (access to a cluster is recommended).
...
In this option it is possible to apply the contrast method to different source data and/or different target relations, however this requires (much) more effort and computational resources. This option is described in a different document, the see [documentation for "full replication"](full-replication.html).
