...
- The "short reproducibility study" proposes to use the exact same preprocessed dataset as described in the paper which can be downloaded from **TODO**. For this option you can go directly to [Part 2](./part2-short-reproducibility-study.html).
